...
import com.bless.paysystemcore.utils.SeqKit;
...
import com.bless.paysystempayment.ctrl.ApiController;
...
import com.bless.paysystempayment.rqrs.payOrder.payway.QrCashierOrderRQ;
import com.bless.paysystempayment.rqrs.payOrder.payway.QrCashierOrderRS;
import com.bless.paysystempayment.service.ConfigContextQueryService;
import com.bless.paysystempayment.service.PayOrderProcessService;
import com.bless.paysystemservice.impl.MchPayPassageService;
import com.bless.paysystemservice.impl.PayOrderService;
...
//        }else
        if( ChannelRetMsg.ChannelState.WAITING == channelRetMsg.getChannelState() ||
